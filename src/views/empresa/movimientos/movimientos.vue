        ...
        <v-card class="border" elevation="0" rounded="0">
            ...
            <v-card-text class="px-0">
                <v-row dense class="align-center px-2">
                    ...
                    <v-col cols="12" sm="4" md="4">
                        <v-autocomplete v-model="search.tipoMov" :items="data.movimientos" density="compact" variant="outlined" label="Tipos de Movimientos" hide-details 
                ...
                <v-data-table :search="data.search" :headers="data.headers" :items="filteredMovimientos" class="border font" density="compact"
                    :row-props="setStyle" hover :header-props="{ class: 'font-weight-bold text-uppercase' }" :loading="data.loading">
