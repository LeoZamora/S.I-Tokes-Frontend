            ...
            <v-card-text id="body-card">
                ...
                <v-form validate-on="invalid-input" ref="form">
                    <v-row dense>
                        <v-col cols="12" md="4" sm="4">
                            <v-text-field v-model="data.ruta.codigo" :rules="data.rules.rule" prepend-inner-icon="mdi-identifier" 
                        ...
                        <v-col cols="12" md="4" sm="4">
                            <v-text-field v-model="data.ruta.gestor" :rules="data.rules.rule" prepend-inner-icon="mdi-account-question" 
                                density="compact" variant="outlined" :hide-details="data.hide ? true : false" 
                        ...
                        <v-col cols="12" md="12" sm="12">
                            <v-textarea v-model="data.ruta.descripcion" density="compact" variant="outlined" 
                                :hide-details="data.hide ? true : false" label="Descripción" placeholder="ingrese algunos detalles de la ruta" 
                ...
                <v-row dense>
                    <v-col cols="12" md="6" sm="6">
                        <v-autocomplete v-model="data.cobertura.idDepartamento" prepend-inner-icon="mdi-shopping" density="compact" variant="outlined" 
                            :hide-details="data.hide ? true : false"  label="Departamento" placeholder="departamentos" persistent-placeholder 
                            :items="data.departamentos" @update:model-value="getMunicipios"/>
                    </v-col>
                    <v-col cols="12" md="6" sm="6">
                        <v-autocomplete v-model="data.cobertura.idMunicipio" prepend-inner-icon="mdi-shopping" density="compact" variant="outlined" 
                            :hide-details="data.hide ? true : false" label="Municipios" placeholder="municipios" persistent-placeholder 
