                            ...
                            <v-tooltip text="Editar" location="top">
                                <template v-slot:activator="{ props }">
                                    <v-icon v-bind="props" size="small" color="green" 
                                        @click="getTipoVentaById(item.id, 'edit')" class="mr-1" >
                                        mdi-pencil
                                    </v-icon>
                                </template>
                            </v-tooltip>
                            ...
                            <v-tooltip text="Ver" location="top">
                                <template v-slot:activator="{ props }">
                                    <v-icon v-bind="props" size="small" color="indigo-darken-4" 
                                        @click="getTipoVentaById(item.id, 'view')">
                                        mdi-eye
                                    </v-icon>
                                </template>
                            </v-tooltip>
...
export default {
    ...
    setup() {
        ...
        const data = reactive({
            ...
            header: [
                ...
                {title: 'Tipo de Movimiento', key: 'nombre', align: 'center'},
            ],
            tipoMov: [],
            visibleDialog: false,
    ...
    methods: {
        ...
        async getTipoVentaById(id, type) {
