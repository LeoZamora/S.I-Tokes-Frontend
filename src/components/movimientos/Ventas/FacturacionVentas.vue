<template>
  <div class="w-100">
    ...
    >
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        <div
                          class="text-h6 font-weight-bold text-green"
                        >
                          {{
      ...
      <v-card-text class="pt-0 px-0">
        ...
        <v-data-table
          ...
          :headers="data.header"
          :items="data.facturas"
          class="font detalleVentas border-t"
          density="compact"
        ...
        >
          <template v-slot:top>
            <v-row dense class="px-4 py-2">
              <v-col cols="12" md="8" sm="8">
                <div class="d-flex align-center">
                  <div
                    class="text-h6 font-weight-bold d-flex align-center text-grey"
                  >
                    <v-icon
                      class="me-2"
                      color="grey"
          ...
          <template
            v-slot:item.estadoMensaje="{ item }"
          >
            <v-btn
              icon
              size="small"
    ...
    <v-dialog
      v-model="data.showAlertAnular"
      max-width="400px"
      persistent
    >
      <v-card elevation="10" rounded>
        <v-card-title
          class="bg-indigo-darken-4 d-flex justify-space-between align-center px-6"
        >
          Anular Factura
        </v-card-title>
    ...
    onMounted(async () => {
      ...
      var steps = [
        ...
        },
        {
          ...
          element: el,
          intro:
            'Hemos mejorado la visulización de los detalles del módulo de ventas.'
        },
        {
          title: 'Detalles de Ventas',
          element: el2,
          intro:
            'Aqui puedes podrás ver todas las facturas registradas, y sus detalles.'
        },
        {
          title: 'Opciones',
          element: el3,
          intro:
            'Al dar click en los tres puntitos, podrás visualizar las diferentes opciones para realizar en base a tus permisos.'
        },
        {
          title: 'Registrar una nueva venta',
          element: el4,
          intro:
            'Para registrar una nueva venta haz click en el botón "Nueva Venta"'
        }
      ]
    ...
    async anularFactura() {
      try {
        ...
        this.data.msgAnular =
          'Anulando factura...'
        const result =
          await this.data.requestHttp.anularVenta(
            this.data.itemSelected.idVenta
          )
